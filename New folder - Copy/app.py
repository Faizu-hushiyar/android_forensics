...
def send_otp(email, otp):
    # Email sender for OTPs – update with real credentials
    sender = "theferl.minecraft@gmail.com"  # TODO: replace with valid sender email
    # For security, consider using environment variables instead of hard‑coding
    password = "Khan@1464"  # TODO: replace with actual app password or fetch from env
